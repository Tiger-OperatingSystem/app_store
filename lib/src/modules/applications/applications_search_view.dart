...
class ApplicationsSearchView extends StatefulWidget {
  final String search;
  const ApplicationsSearchView({
    super.key,
    required this.search,
  });

  @override
  State<ApplicationsSearchView> createState() => _ApplicationsSearchViewState();
}

List _itemsWithIcon = [];

class _ApplicationsSearchViewState extends State<ApplicationsSearchView> {
  final String categoryName = "Pesquisa";

  late String endpoint = "search/${widget.search}";
