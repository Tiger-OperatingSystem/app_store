...
class CategoriesNetworkingView extends StatefulWidget {
  const CategoriesNetworkingView({super.key});

  @override
  State<CategoriesNetworkingView> createState() => _CategoriesNetworkingViewState();
}

List _itemsWithIcon = [];

class _CategoriesNetworkingViewState extends State<CategoriesNetworkingView> {
  final String categoryName = "Networking";

  final String endpoint = "category/Network";
