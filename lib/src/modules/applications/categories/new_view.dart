...
class CategoriesNewView extends StatefulWidget {
  const CategoriesNewView({super.key});

  @override
  State<CategoriesNewView> createState() => _CategoriesNewViewState();
}

List _itemsWithIcon = [];

class _CategoriesNewViewState extends State<CategoriesNewView> {
